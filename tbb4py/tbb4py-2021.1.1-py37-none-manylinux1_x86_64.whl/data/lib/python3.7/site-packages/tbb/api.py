...
def runtime_version():
    return _api.runtime_version()
runtime_version = _api.runtime_version

def runtime_interface_version():
    return _api.runtime_interface_version()
runtime_interface_version = _api.runtime_interface_version

def this_task_arena_max_concurrency():
    return _api.this_task_arena_max_concurrency()
this_task_arena_max_concurrency = _api.this_task_arena_max_concurrency

def this_task_arena_current_thread_index():
    return _api.this_task_arena_current_thread_index()
